...
{
    static DWORD dwFunc = gSignatures.GetClientSignature("55 8B EC 8B 45 08 83 F8 6E 73 0D");
...
{
    typedef int(__thiscall * OriginalFn)(PVOID);
    return getvfunc<OriginalFn>(this, 424)(this);
}
...
bool CTFBaseWeaponMelee::DoSwingTrace(trace_t &trace)
{
    ...
    return getvfunc<OriginalFn>(this, 446)(this, trace);
}
