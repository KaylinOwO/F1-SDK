...
CEntTag::CEntTag (CBaseEntity *ent)
    : tags (EntTag::NO_TAGS)
{
	if (ent == nullptr)
		return;
	...
	if (c == classId::CTFPlayer) {
		...
		return;
	} else if (c == classId::CTFGrenadePipebombProjectile || c == classId::CTFProjectile_Arrow || c == classId::CTFProjectile_Flare || c == classId::CTFProjectile_Rocket || c == classId::CTFProjectile_SentryRocket || c == classId::CTFProjectile_Jar || c == classId::CTFProjectile_JarMilk) {
